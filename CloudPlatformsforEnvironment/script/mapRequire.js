...
var url_featureLayer_enterprise = "https://localhost:6443/arcgis/rest/services/CloudPlatformsforEnvironment/CloudPlatformsforEnvironment/FeatureServer/0";

var url_featureLayer_split = "https://localhost:6443/arcgis/rest/services/CloudPlatformsforEnvironment/CloudPlatformsforEnvironment/FeatureServer/1";

var url_featureLayer_region = "https://localhost:6443/arcgis/rest/services/CloudPlatformsforEnvironment/CloudPlatformsforEnvironment/FeatureServer/2";

var url_gpPointDensity = "https://localhost:6443/arcgis/rest/services/CloudPlatformsforEnvironment/PointDensityService";

var url_gpIDW = "https://localhost:6443/arcgis/rest/services/CloudPlatformsforEnvironment/IDWService";

var url_imgHistoryDetection_IDW = "https://localhost:6443/arcgis/rest/services/CloudPlatformsforEnvironment/HistoryDetection_IDW_0";

var url_imgHistoryDetection_PD = "https://localhost:6443/arcgis/rest/services/CloudPlatformsforEnvironment/HistoryDetection_PD_0";;

var url_imgChangeDetection_IDW = "https://localhost:6443/arcgis/rest/services/CloudPlatformsforEnvironment/ChangeDetection_IDW_0";

var url_imgChangeDetection_PD = "https://localhost:6443/arcgis/rest/services/CloudPlatformsforEnvironment/ChangeDetection_PD_0";
...
function mapRequire() {
    require([
        ...
        var routeTask = new RouteTask({
            url: "http://utility.arcgis.com/usrsvcs/appservices/sgcR7S40icnYzN8l/rest/services/World/Route/NAServer/Route_World"
        });
        ...
        function doGeoprocessor(gpName, timeIndex, city, field) {
            ...
            if (gpName == "HistoryDetectionService") {
                ...
                if ($('#timeline-window').prop('className') == 'historyDetection_IDW') {
                    ...
                    gpMapUrl = imgHistoryDetection_IDW + timeIndex + '/MapServer';;
                    ...
                    gpMapUrl = imgHistoryDetection_PD + timeIndex + '/MapServer';
                ...
                if ($('#timelineless-window').prop('className') == 'changeDetection_IDW') {
                    ...
                    gpMapUrl = imgChangeDetection_IDW + timeIndex + '/MapServer';
                    ...
                    gpMapUrl = imgChangeDetection_PD + timeIndex + '/MapServer';
