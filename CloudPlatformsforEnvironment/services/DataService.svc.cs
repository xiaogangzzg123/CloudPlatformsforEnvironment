...
namespace CloudPlatformsforEnvironment
{
    ...
    {
        string conStr = "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=CloudPlatformsforEnvironment;User Id=intMinor;Password=2016;Data Source=INTMINOR-PC\\SQLEXPRESS";
